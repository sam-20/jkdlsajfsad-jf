...
@IonicPage()
@Component({
  selector: 'page-mymessages2',
  templateUrl: 'mymessages2.html',
})
export class Mymessages2Page {
  user_id_retrieved: any; //this is needed to load the usr's info for this page
  ...
  loadallusermessages() {
    ...
    let body = {
      globaluseridDB: this.user_id_retrieved,  //used for reading from db for a particular user
